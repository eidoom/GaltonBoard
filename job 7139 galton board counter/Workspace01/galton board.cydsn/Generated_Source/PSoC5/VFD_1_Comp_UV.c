...
uint8 VFD_1_Comp_UV_initVar = 0u;

/* Internal functions definitoin */
static void VFD_1_Comp_UV_trimAdjust(uint8 nibble) ;

/* static VFD_1_Comp_UV_backupStruct  VFD_1_Comp_UV_backup; */
#if (CY_PSOC5A)
    static VFD_1_Comp_UV_LOWPOWER_BACKUP_STRUCT  VFD_1_Comp_UV_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 VFD_1_Comp_UV_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: VFD_1_Comp_UV_Init
********************************************************************************
*
* Summary:
...
void VFD_1_Comp_UV_Init(void) 
{
    ...
    VFD_1_Comp_UV_SetSpeed(VFD_1_Comp_UV_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( VFD_1_Comp_UV_DEFAULT_HYSTERESIS == 0u )
        VFD_1_Comp_UV_CR |= VFD_1_Comp_UV_HYST_OFF;
    #else
        VFD_1_Comp_UV_CR &= (uint8)(~VFD_1_Comp_UV_HYST_OFF);
    #endif /* VFD_1_Comp_UV_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( VFD_1_Comp_UV_DEFAULT_PWRDWN_OVRD == 0u )
            VFD_1_Comp_UV_CR &= (uint8)(~VFD_1_Comp_UV_PWRDWN_OVRD);
        #else 
            VFD_1_Comp_UV_CR |= VFD_1_Comp_UV_PWRDWN_OVRD;
        #endif /* VFD_1_Comp_UV_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    VFD_1_Comp_UV_CR |= VFD_1_Comp_UV_MX_AO;

    /* Set default sync */
    VFD_1_Comp_UV_CLK &= (uint8)(~VFD_1_Comp_UV_SYNCCLK_MASK);
    #if ( VFD_1_Comp_UV_DEFAULT_BYPASS_SYNC == 0u )
        VFD_1_Comp_UV_CLK |= VFD_1_Comp_UV_SYNC_CLK_EN;
    #else
        VFD_1_Comp_UV_CLK |= VFD_1_Comp_UV_BYPASS_SYNC;
    #endif /* VFD_1_Comp_UV_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: VFD_1_Comp_UV_Enable
********************************************************************************
*
* Summary:
...
{
    VFD_1_Comp_UV_PWRMGR |= VFD_1_Comp_UV_ACT_PWR_EN;
    VFD_1_Comp_UV_STBY_PWRMGR |= VFD_1_Comp_UV_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(VFD_1_Comp_UV_restoreReg == 1u)
        {
            VFD_1_Comp_UV_CR = VFD_1_Comp_UV_lowPowerBackup.compCRReg;

            /* Clear the flag */
            VFD_1_Comp_UV_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: VFD_1_Comp_UV_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  VFD_1_Comp_UV_initVar: Is modified when this function is called for the 
...
void VFD_1_Comp_UV_Start(void) 
{
    ...
    if ( VFD_1_Comp_UV_initVar == 0u )
    {
        VFD_1_Comp_UV_Init();
        
        VFD_1_Comp_UV_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: VFD_1_Comp_UV_Stop
********************************************************************************
*
* Summary:
...
void VFD_1_Comp_UV_Stop(void) 
{
    ...
    VFD_1_Comp_UV_PWRMGR &= (uint8)(~VFD_1_Comp_UV_ACT_PWR_EN);
    VFD_1_Comp_UV_STBY_PWRMGR &= (uint8)(~VFD_1_Comp_UV_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        VFD_1_Comp_UV_restoreReg = 1u;

        /* Save the control register before clearing it */
        VFD_1_Comp_UV_lowPowerBackup.compCRReg = VFD_1_Comp_UV_CR;
        VFD_1_Comp_UV_CR = VFD_1_Comp_UV_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: VFD_1_Comp_UV_SetSpeed
********************************************************************************
*
* Summary:
...
void VFD_1_Comp_UV_SetSpeed(uint8 speed) 
{
    ...
    VFD_1_Comp_UV_CR = (VFD_1_Comp_UV_CR & (uint8)(~VFD_1_Comp_UV_PWR_MODE_MASK)) |
                           (speed & VFD_1_Comp_UV_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == VFD_1_Comp_UV_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            VFD_1_Comp_UV_TR = VFD_1_Comp_UV_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            VFD_1_Comp_UV_TR0 = VFD_1_Comp_UV_HS_TRIM_TR0;
            VFD_1_Comp_UV_TR1 = VFD_1_Comp_UV_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            VFD_1_Comp_UV_TR = VFD_1_Comp_UV_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            VFD_1_Comp_UV_TR0 = VFD_1_Comp_UV_LS_TRIM_TR0;
            VFD_1_Comp_UV_TR1 = VFD_1_Comp_UV_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: VFD_1_Comp_UV_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( VFD_1_Comp_UV_WRK & VFD_1_Comp_UV_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: VFD_1_Comp_UV_trimAdjust
********************************************************************************
*
* Summary:
...
static void VFD_1_Comp_UV_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = VFD_1_Comp_UV_WRK & VFD_1_Comp_UV_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VFD_1_Comp_UV_TR |= VFD_1_Comp_UV_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VFD_1_Comp_UV_TR0 |= VFD_1_Comp_UV_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VFD_1_Comp_UV_TR |= VFD_1_Comp_UV_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VFD_1_Comp_UV_TR1 |= VFD_1_Comp_UV_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        ...
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                VFD_1_Comp_UV_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                VFD_1_Comp_UV_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((VFD_1_Comp_UV_WRK & VFD_1_Comp_UV_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: VFD_1_Comp_UV_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 VFD_1_Comp_UV_ZeroCal(void) 
{
    ...
    tmpSW0 = VFD_1_Comp_UV_SW0;
    tmpSW2 = VFD_1_Comp_UV_SW2;
    tmpSW3 = VFD_1_Comp_UV_SW3;

     /* Clear routing for inP, retain routing for inN */
    VFD_1_Comp_UV_SW0 = 0x00u;
    VFD_1_Comp_UV_SW2 = 0x00u;
    VFD_1_Comp_UV_SW3 = tmpSW3 & (uint8)(~VFD_1_Comp_UV_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = VFD_1_Comp_UV_CR;
    VFD_1_Comp_UV_CR |= (VFD_1_Comp_UV_CAL_ON | VFD_1_Comp_UV_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        VFD_1_Comp_UV_TR = VFD_1_Comp_UV_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        VFD_1_Comp_UV_TR0 = VFD_1_Comp_UV_DEFAULT_CMP_TRIM;
        VFD_1_Comp_UV_TR1 = VFD_1_Comp_UV_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (VFD_1_Comp_UV_CR & VFD_1_Comp_UV_PWR_MODE_MASK) == VFD_1_Comp_UV_PWR_MODE_FAST)
    {
        VFD_1_Comp_UV_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        VFD_1_Comp_UV_trimAdjust(1u);
		VFD_1_Comp_UV_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    VFD_1_Comp_UV_CR = tmpCR;
    
    /* Restore routing registers for inP */
    VFD_1_Comp_UV_SW0 = tmpSW0;
    VFD_1_Comp_UV_SW2 = tmpSW2;
    VFD_1_Comp_UV_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) VFD_1_Comp_UV_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)VFD_1_Comp_UV_TR1 << 8u) | (VFD_1_Comp_UV_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: VFD_1_Comp_UV_LoadTrim
********************************************************************************
*
* Summary:
...
void VFD_1_Comp_UV_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: VFD_1_Comp_UV_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: VFD_1_Comp_UV_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
