                                   ...
                                   
{
        ...
        Counter_3_GLOBAL_ENABLE &= ((uint8)(~Counter_3_BLOCK_EN_MASK));
    #else
        CY_SET_REG8(Counter_3_COUNTER_LSB_PTR, counter);
    #endif /* (Counter_3_UsingFixedFunction) */
}
#endif /* (!(Counter_3_UsingFixedFunction && (CY_PSOC5A))) */
...
uint8 Counter_3_ReadCounter(void) 
{
    ...
    #if(Counter_3_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(Counter_3_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG8(Counter_3_STATICCOUNT_LSB_PTR));
    #endif /* (Counter_3_UsingFixedFunction) */
}
...
void Counter_3_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(Counter_3_PERIOD_LSB_PTR, period);
    #endif /* (Counter_3_UsingFixedFunction) */
}
...
{
    #if(Counter_3_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(Counter_3_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(Counter_3_PERIOD_LSB_PTR));
    #endif /* (Counter_3_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG8(Counter_3_COMPARE_LSB_PTR, compare);
    #endif /* (Counter_3_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG8(Counter_3_COMPARE_LSB_PTR));
}
