...
uint8 ScanComp_1_Comp_initVar = 0u;

/* Internal functions definitoin */
static void ScanComp_1_Comp_trimAdjust(uint8 nibble) ;

/* static ScanComp_1_Comp_backupStruct  ScanComp_1_Comp_backup; */
#if (CY_PSOC5A)
    static ScanComp_1_Comp_LOWPOWER_BACKUP_STRUCT  ScanComp_1_Comp_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 ScanComp_1_Comp_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: ScanComp_1_Comp_Init
********************************************************************************
*
* Summary:
...
void ScanComp_1_Comp_Init(void) 
{
    ...
    ScanComp_1_Comp_SetSpeed(ScanComp_1_Comp_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( ScanComp_1_Comp_DEFAULT_HYSTERESIS == 0u )
        ScanComp_1_Comp_CR |= ScanComp_1_Comp_HYST_OFF;
    #else
        ScanComp_1_Comp_CR &= (uint8)(~ScanComp_1_Comp_HYST_OFF);
    #endif /* ScanComp_1_Comp_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( ScanComp_1_Comp_DEFAULT_PWRDWN_OVRD == 0u )
            ScanComp_1_Comp_CR &= (uint8)(~ScanComp_1_Comp_PWRDWN_OVRD);
        #else 
            ScanComp_1_Comp_CR |= ScanComp_1_Comp_PWRDWN_OVRD;
        #endif /* ScanComp_1_Comp_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    ScanComp_1_Comp_CR |= ScanComp_1_Comp_MX_AO;

    /* Set default sync */
    ScanComp_1_Comp_CLK &= (uint8)(~ScanComp_1_Comp_SYNCCLK_MASK);
    #if ( ScanComp_1_Comp_DEFAULT_BYPASS_SYNC == 0u )
        ScanComp_1_Comp_CLK |= ScanComp_1_Comp_SYNC_CLK_EN;
    #else
        ScanComp_1_Comp_CLK |= ScanComp_1_Comp_BYPASS_SYNC;
    #endif /* ScanComp_1_Comp_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: ScanComp_1_Comp_Enable
********************************************************************************
*
* Summary:
...
{
    ScanComp_1_Comp_PWRMGR |= ScanComp_1_Comp_ACT_PWR_EN;
    ScanComp_1_Comp_STBY_PWRMGR |= ScanComp_1_Comp_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(ScanComp_1_Comp_restoreReg == 1u)
        {
            ScanComp_1_Comp_CR = ScanComp_1_Comp_lowPowerBackup.compCRReg;

            /* Clear the flag */
            ScanComp_1_Comp_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: ScanComp_1_Comp_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  ScanComp_1_Comp_initVar: Is modified when this function is called for the 
...
void ScanComp_1_Comp_Start(void) 
{
    ...
    if ( ScanComp_1_Comp_initVar == 0u )
    {
        ScanComp_1_Comp_Init();
        
        ScanComp_1_Comp_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: ScanComp_1_Comp_Stop
********************************************************************************
*
* Summary:
...
void ScanComp_1_Comp_Stop(void) 
{
    ...
    ScanComp_1_Comp_PWRMGR &= (uint8)(~ScanComp_1_Comp_ACT_PWR_EN);
    ScanComp_1_Comp_STBY_PWRMGR &= (uint8)(~ScanComp_1_Comp_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        ScanComp_1_Comp_restoreReg = 1u;

        /* Save the control register before clearing it */
        ScanComp_1_Comp_lowPowerBackup.compCRReg = ScanComp_1_Comp_CR;
        ScanComp_1_Comp_CR = ScanComp_1_Comp_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: ScanComp_1_Comp_SetSpeed
********************************************************************************
*
* Summary:
...
void ScanComp_1_Comp_SetSpeed(uint8 speed) 
{
    ...
    ScanComp_1_Comp_CR = (ScanComp_1_Comp_CR & (uint8)(~ScanComp_1_Comp_PWR_MODE_MASK)) |
                           (speed & ScanComp_1_Comp_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == ScanComp_1_Comp_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            ScanComp_1_Comp_TR = ScanComp_1_Comp_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            ScanComp_1_Comp_TR0 = ScanComp_1_Comp_HS_TRIM_TR0;
            ScanComp_1_Comp_TR1 = ScanComp_1_Comp_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            ScanComp_1_Comp_TR = ScanComp_1_Comp_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            ScanComp_1_Comp_TR0 = ScanComp_1_Comp_LS_TRIM_TR0;
            ScanComp_1_Comp_TR1 = ScanComp_1_Comp_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: ScanComp_1_Comp_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( ScanComp_1_Comp_WRK & ScanComp_1_Comp_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: ScanComp_1_Comp_trimAdjust
********************************************************************************
*
* Summary:
...
static void ScanComp_1_Comp_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = ScanComp_1_Comp_WRK & ScanComp_1_Comp_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                ScanComp_1_Comp_TR |= ScanComp_1_Comp_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                ScanComp_1_Comp_TR0 |= ScanComp_1_Comp_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                ScanComp_1_Comp_TR |= ScanComp_1_Comp_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                ScanComp_1_Comp_TR1 |= ScanComp_1_Comp_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                ScanComp_1_Comp_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                ScanComp_1_Comp_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                ScanComp_1_Comp_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                ScanComp_1_Comp_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((ScanComp_1_Comp_WRK & ScanComp_1_Comp_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: ScanComp_1_Comp_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 ScanComp_1_Comp_ZeroCal(void) 
{
    ...
    tmpSW0 = ScanComp_1_Comp_SW0;
    tmpSW2 = ScanComp_1_Comp_SW2;
    tmpSW3 = ScanComp_1_Comp_SW3;

     /* Clear routing for inP, retain routing for inN */
    ScanComp_1_Comp_SW0 = 0x00u;
    ScanComp_1_Comp_SW2 = 0x00u;
    ScanComp_1_Comp_SW3 = tmpSW3 & (uint8)(~ScanComp_1_Comp_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = ScanComp_1_Comp_CR;
    ScanComp_1_Comp_CR |= (ScanComp_1_Comp_CAL_ON | ScanComp_1_Comp_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        ScanComp_1_Comp_TR = ScanComp_1_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        ScanComp_1_Comp_TR0 = ScanComp_1_Comp_DEFAULT_CMP_TRIM;
        ScanComp_1_Comp_TR1 = ScanComp_1_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (ScanComp_1_Comp_CR & ScanComp_1_Comp_PWR_MODE_MASK) == ScanComp_1_Comp_PWR_MODE_FAST)
    {
        ScanComp_1_Comp_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        ScanComp_1_Comp_trimAdjust(1u);
		ScanComp_1_Comp_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    ScanComp_1_Comp_CR = tmpCR;
    
    /* Restore routing registers for inP */
    ScanComp_1_Comp_SW0 = tmpSW0;
    ScanComp_1_Comp_SW2 = tmpSW2;
    ScanComp_1_Comp_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) ScanComp_1_Comp_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)ScanComp_1_Comp_TR1 << 8u) | (ScanComp_1_Comp_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: ScanComp_1_Comp_LoadTrim
********************************************************************************
*
* Summary:
...
void ScanComp_1_Comp_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: ScanComp_1_Comp_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: ScanComp_1_Comp_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
